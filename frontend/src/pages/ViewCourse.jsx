...
function ViewCourse() {
  ...
  return (
    <div className='min-h-screen bg-[#f9fafb] p-8'>
        <div className='max-w-6xl mx-auto bg-white shadow-lg rounded-2xl p-6 flex flex-col gap-8 relative'>
            ...
            <div className='flex flex-col md:flex-row gap-6 w-full'>
                ...
                <div className='w-full md:w-[50%] relative'>
                    <FaArrowLeftLong className='text-black text-[22px] cursor-pointer hover:scale-110 transition-transform'
                    onClick={()=>navigate("/")}/>
                    {selectedCourse?.thumbnail ?  <img src={selectedCourse.thumbnail} alt='' className='rounded-xl w-full object-cover h-[250px] md:h-[220px]' /> : <img src={img} alt='' className='rounded-xl w-full object-cover h-[250px] md:h-[220px]'/>}
                </div>

                {/* Course Info */}
                <div className='flex-1 space-y-2 md:pt-4'>
                    <h2 className='text-[22px] font-bold text-gray-900'>{selectedCourse?.title}</h2>
                    ...
                    <div className='flex items-start flex-col justify-between'>
                        ...
                        <div>
                            ...
                            <span className='line-through text-gray-400 text-sm'>₹599</span>
                        </div>

                        <ul className='text-sm text-gray-700 space-y-1 pt-2'>
                            <li>✔️10+ hours of video content</li>
                            <li>✔️Lifetime access to course materials</li>     
                       </ul>

                       {!isEnrolled ? <button className='bg-black text-white px-6 py-2 rounded-lg hover:bg-gray-800 mt-3 cursor-pointer transition-all'
                       onClick={()=>handleEnroll(userData._id,courseId)}>
                        Enroll Now
                       </button> : <button className='bg-green-100 text-green-500 px-6 py-2 rounded-lg hover:bg-gray-800 mt-3 cursor-pointer transition-all'
            ...
            <div className='mt-8 border-t pt-6'>
                ...
                <div className='mb-4'>
                    ...
                    disabled={loading} onClick={handleReview}>
