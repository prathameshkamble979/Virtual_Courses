      ...
      <div className='bg-gray-50 p-6 rounded-md'>
        ...
        <form className='space-y-6' onSubmit={(e)=>e.preventDefault()}>
          ...
          <div>
             ...
             <input id='subtitle' type='text' className='w-full border px-4 py-2 rounded-md ' placeholder='courseSubtitle'
          ...
          <div>
             ...
             <textarea id='dis' type="text" className='w-full border px-4 py-2 rounded-md h-24 resize-none' placeholder='Course Description'
          ...
          <div className='relative w-[300px] h-[170px]'>
              <img src={frontendImage} alt='' className='w-[100%] h-[100%] border-1 border-black rounded-[5px] cursor-pointer'
