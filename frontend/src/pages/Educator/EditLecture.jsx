  ...
  return (
    <div className='min-h-screen bg-gray-100 flex items-center justify-center p-4'>
      <div className='w-full max-w-xl bg-white rounded-xl shadow-lg p-6 space-y-6'>
        ...
        <button className='mt-2 px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 transition-all text-sm cursor-pointer'
        disabled={loading1}
        ...
        <div className='space-y-4'>
          ...
          <div>
            <label className='block text-sm font-medium text-gray-700 mb-1' 
            htmlFor=''>Video *</label>
            <input type='file' className='w-full border border-gray-300 rounded-md p-2 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:bg-gray-700 file:text-[white] hover:file:bg-gray-500' required accept='video/*'
          ...
          <div className='flex items-center gap-3'>
            ...
            <label htmlFor='isFree' className='text-sm text-gray-700'>Is this FREE</label>
          </div>
